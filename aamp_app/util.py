        ...
        "init": {
            ...
            "args": {
                ...
                "default_integration_time": {
                    "default": (100,),
                    "type": tuple,
                    "notes": "Default integration time in ms. A single value applies to all selected spectrometers; tuple/list values follow spec_keys order.",
                },
            },
        },
        "commands": {
            ...
            "SpectrometerUpdateDark": {
                ...
                "args": {
                    "receiver": {"default": "StellarNetSpectrometer", "type": str, "notes": "Name of the device"},
                    "integration_times": {"default": (100,), "type": tuple, "notes": "Integration times in ms. A single value applies to all selected spectrometers; tuple/list values follow spec_keys order."},
                    "scans_to_avg": {"default": (3,), "type": tuple, "notes": "Scans-to-average values. A single value applies to all selected spectrometers; tuple/list values follow spec_keys order."},
                    "smoothings": {"default": (0,), "type": tuple, "notes": "Smoothing values. A single value applies to all selected spectrometers; tuple/list values follow spec_keys order."},
                    "xtimings": {"default": (1,), "type": tuple, "notes": "X timing values. A single value applies to all selected spectrometers; tuple/list values follow spec_keys order."},
                },
            ...
            "SpectrometerGetAbsorbancebyname": {
                ...
                "args": {
                    ...
                    "integration_times": {"default": None, "type": tuple, "notes": "Optional integration times in ms. Uses the device default when omitted; otherwise a single value applies to all selected spectrometers or tuple/list values follow spec_keys order."},
                    "scans_to_avg": {"default": (3,), "type": tuple, "notes": "Scans-to-average values. A single value applies to all selected spectrometers; tuple/list values follow spec_keys order."},
                    "smoothings": {"default": (0,), "type": tuple, "notes": "Smoothing values. A single value applies to all selected spectrometers; tuple/list values follow spec_keys order."},
                    "xtimings": {"default": (1,), "type": tuple, "notes": "X timing values. A single value applies to all selected spectrometers; tuple/list values follow spec_keys order."},
