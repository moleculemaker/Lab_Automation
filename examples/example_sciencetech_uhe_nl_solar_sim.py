...
def main() -> None:
    ...
    seq.add_command(SciencetechUHENLSolarSimSetAttenuator(simulator, percent=35))
    seq.add_command(SciencetechUHENLSolarSimGetFeedback(simulator, feedback_type="attenuator"))
    ...
    print("Sequence: initialize with lamp OFF, close shutter, set attenuator to 35%, ignite lamp,")
