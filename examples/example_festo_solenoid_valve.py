...
def main() -> None:
    ...
    seq.add_command(FestoValveOpen(valve, valve_num=PIN4_VALVE_NUM, delay=1.0))
    seq.add_command(FestoValveClosed(valve, valve_num=PIN4_VALVE_NUM, delay=5))
    seq.add_command(FestoValveOpen(valve, valve_num=PIN8_VALVE_NUM, delay=1.0))
    seq.add_command(FestoValveClosed(valve, valve_num=PIN8_VALVE_NUM, delay=5))
    seq.add_command(FestoCloseAll(valve))
